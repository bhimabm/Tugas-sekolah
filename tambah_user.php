...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (empty($name) || empty($email) || empty($password)) {
    ...
    if ($stmt->rowCount() > 0) {
      ...
      // Insert user baru
      $stmt = $db->prepare("
        INSERT INTO users (name, email, password, nis, kelas, is_admin)
        VALUES (?, ?, ?, ?, ?, ?)
      ");
      
      try {
        $stmt->execute([$name, $email, $hashed_password, $nis, $kelas, $is_admin]);
...
<head>
  ...
  <title>Tambah Pengguna - Sistem Pengaduan</title>
        ...
        <form method="POST" action="">
          ...
          <div class="row-2col">
            <div class="form-group">
              ...
              <input type="text" id="nis" name="nis" class="form-control" placeholder="Nomor Induk Siswa (opsional)">
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" id="kelas" name="kelas" class="form-control" placeholder="Contoh: X RPL (opsional)">
            </div>
          </div>
          ...
          <div class="form-group" style="margin-top: 25px; margin-bottom: 30px;">
            <label class="form-label" style="margin-bottom: 12px;">
              <i class="fas fa-shield-alt" style="color: var(--primary);"></i> Role Pengguna
            </label>
            <div class="form-check" style="background: transparent; padding: 0;">
              <div style="display:flex; align-items:center; gap:12px; justify-content:space-between; width:100%;">
                ...
                <div class="toggle">
                  <input type="checkbox" id="is_admin" name="is_admin" class="toggle-input">
